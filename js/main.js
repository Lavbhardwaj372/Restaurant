...
document.getElementById("reservationPopup").classList.add("active");
}
...
let message = `Table Reservation:%0AName: ${name}%0ADate: ${date}%0ATime: ${time}%0APeople: ${people}`;

let url = "https://wa.me/917505841779?text=" + message;
